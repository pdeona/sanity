export const files = [
...

  {
    ...
    vars: [
      ...
      {name: '--input-box-shadow-base', type: 'shadow'},
      ...
      {name: '--fieldset-box-shadow'},
      {name: '--fieldset-box-shadow--hover'},
      {name: '--fieldset-box-shadow--invalid'},
      {name: '--fieldset-box-shadow--focus'},
      {name: '--fieldset-box-shadow--invalid-focus'},
      {name: '--fieldset-bg'},
      ...
      {name: '--form-builder-block-shadow'},
      {name: '--form-builder-block-shadow--hover'},
      {name: '--form-builder-block-shadow--focus'},
      {name: '--form-builder-block-shadow--invalid'},
      {name: '--form-builder-block-shadow--invalid-focus'},
